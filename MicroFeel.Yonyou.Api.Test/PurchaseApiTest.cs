...
namespace MicroFeel.Yonyou.Api.Test
{
    ...
    public class PurchaseApiTest : ApiTest
    {
        ...
        [TestMethod]
        public async Task MyTestBatch_Get_PurchaserequisitionlistAsync()
        {
            var api = new PurchaseApi();
            api.Init(base_url, appkey, appSecret, from_account, to_account);
            var result = await api.Batch_Get_PurchaserequisitionlistAsync();
            var jsonResult = System.Text.Json.JsonSerializer.Serialize(result, JsonOptions);
            Console.WriteLine(jsonResult);
            Assert.IsNotNull(jsonResult);
        ...
        [TestMethod]
        public async Task MyTestGet_PurchaserequisitionAsync()
        {
            var api = new PurchaseApi();
            api.Init(base_url, appkey, appSecret, from_account, to_account);
            var result = await api.Get_PurchaserequisitionAsync("QG2004150040");
            var jsonResult = System.Text.Json.JsonSerializer.Serialize(result, JsonOptions);
            Console.WriteLine(jsonResult);
            Assert.IsNotNull(jsonResult);
        }
        ...
        //    var json = System.Text.Json.JsonSerializer.Deserialize<PurchaseorderListResult>(s);
