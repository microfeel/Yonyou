...
namespace MicroFeel.Yonyou.Api.Service
{
    ...
    public class PurchaseApi : Api
    {
        ...
        /// </summary> 
        /// <return></return>
        public async System.Threading.Tasks.Task<DbResult> Add_PurchaseorderAsync(Purchaseorder purchaseorder, string bizId = null, int dsSequence = 1, bool sync = true)
        {
